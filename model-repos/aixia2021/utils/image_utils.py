def get_spatial_feat(bbox, im_width, im_height):
    ...
    x_left = (1.0 * x_left / im_width) * 2 - 1
    x_right = (1.0 * x_right / im_width) * 2 - 1
    x_center = (1.0 * x_center / im_width) * 2 - 1

    y_lower = (1.0 * y_lower / im_height) * 2 - 1
    y_upper = (1.0 * y_upper / im_height) * 2 - 1
    y_center = (1.0 * y_center / im_height) * 2 - 1

    x_width = (1.0 * x_width / im_width) * 2
    y_height = (1.0 * y_height / im_height) * 2
