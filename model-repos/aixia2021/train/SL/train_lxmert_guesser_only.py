...
if __name__ == '__main__':
    ...
    if args.resnet:
        ...
        dataset_train = N2NLXMERTDataset(split='train', **dataset_args, complete_only=True, imgid2fasterRCNNfeatures=imgid2fasterRCNNfeatures, num_turns=args.num_turns)
        dataset_val = N2NLXMERTDataset(split='val', **dataset_args, complete_only=True, imgid2fasterRCNNfeatures=imgid2fasterRCNNfeatures, num_turns=args.num_turns)
