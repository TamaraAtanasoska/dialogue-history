...
class LooperBatchifier(AbstractBatchifier):
    ...
    def filter(self, games):
        ...
        if self.generate_new_games:
            ...
            return copy.deepcopy(
                potential_game_list
            )  # deep copy to perserve the original dataset
        else:
            return games
    ...
    def apply(self, games):
        ...
        for i, game in enumerate(games):
            ...
            obj_spats = [
                get_spatial_feat(obj.bbox, game.image.width, game.image.height)
            ...
            batch["debug"].append(
                (
                    ...
                    (target_object.bbox.x_center, target_object.bbox.y_center),
                    game.image.url,
                )
            )
